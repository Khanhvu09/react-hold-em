...
class PokerTable extends Component{
    ...
    prepDeck(){
        ...
        // deck is now only 48, because we mutated this.deck
        // when we ran shift
        this.setState({
    ...
    draw(){
        // we have to use Object.assign (or ...) to make a seperate copt of state
